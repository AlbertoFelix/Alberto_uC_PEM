...
//altsyncram ADDRESS_ACLR_A="NONE" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV E" ENABLE_RUNTIME_MOD="NO" INIT_FILE="Dados.hex" NUMWORDS_A=32 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="UNREGISTERED" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=5 address_a clock0 q_a
...
module  Rom_Operandos_altsyncram
	( 
	address_a,
	clock0,
...
`endif
	...
	defparam
		...
		ram_block1a_0.mem_init0 = 32'h0000000F,
	...
	defparam
		...
		ram_block1a_1.mem_init0 = 32'h00000009,
	...
	defparam
		...
		ram_block1a_2.mem_init0 = 32'h0000000E,
	...
	defparam
		...
		ram_block1a_3.mem_init0 = 32'h00000009,
	...
	defparam
		...
		ram_block1a_4.mem_init0 = 32'h0000000C,
	...
	defparam
		...
		ram_block1a_5.mem_init0 = 32'h00000009,
	...
	defparam
		...
		ram_block1a_6.mem_init0 = 32'h0000000A,
	...
	defparam
		...
		ram_block1a_7.mem_init0 = 32'h00000007,
...
endmodule //Rom_Operandos_altsyncram
//VALID FILE
...
`endif
	...
	Rom_Operandos_altsyncram	Rom_Operandos_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.q_a (sub_wire0));
